...
1. Созданы новые микросервисы для управления [телеметрией](apps/telemetry-service) и [устройствами](apps/device-service), которые интегрированы с существующим монолитным приложением. Микросервис телеметрии реализован на Python+FastAPI, микросервис устройств на Java+Spring.
...
В результате созданы [Dockerfile микросервиса для управления телеметрией](apps/telemetry-service/Dockerfile), [Dockerfile микросервиса для управления устройствами](apps/device-service/Dockerfile) и [docker-compose](apps/docker-compose-mvp.yml) для запуска микросервисов.
Также добавлена [Postman коллекция](apps/MVP.postman_collection.json) для тестирования.
